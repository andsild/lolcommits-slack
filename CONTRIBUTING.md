...
[Fork](https://guides.github.com/activities/forking) then clone the repository:
    ...
    git clone git@github.com:your-username/lolcommits-mumble.git
...
Request](https://github.com/lolcommits/lolcommits-mumble/compare):
...
* If you are fixing an
  [issue](https://github.com/lolcommits/lolcommits-mumble/issues), link to
